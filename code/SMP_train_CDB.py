...
from SMP_dataset_CDB import train, validation, save_model
...
# Loss function 정의
from losses import DiceFocalLoss, CDB_loss
# criterion = DiceFocalLoss()
criterion = CDB_loss(class_difficulty = np.ones(11)).cuda()
...
wandb.init(project="semantic_segmentation_baseline", entity="cv_09_semanticsegmentation", name="SMP_PAN_SwinL_StepLR_AUG2_CDBloss")    ########## 바꿔주세요 ##########
wandb.config = {
